...
consecutiveNumbers(16);
    ...
    public static void consecutiveNumbers(int n) {
        ...
        for (int i = 1; i <= n; i++) {
            ...
            System.out.println(result.isEmpty() ? i : result); //if my result is empty print number which is i, otherwise if my result is not empty, one of those "if" is true just print result
        }
    }
}
